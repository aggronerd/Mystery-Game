...
public:
  ...
  std::vector<BBN_Decision*>* get_decisions(void);
	...
	bool set_result(const CL_String8&, const CL_String8&);
	void clear_bn(void);
	CL_String8 get_file_name(void);
