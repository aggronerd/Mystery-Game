...
void MainWindow::load_selected_node_tables_into_ppt_grid (
)
{
...
void MainWindow::load_selected_node_tables_into_cpt_grid (
)
{
...
void MainWindow::initialize_node_cpt_if_necessary (
    unsigned long index
)
{
...
void MainWindow::no_node_selected (
)
{
...
void MainWindow::recalculate_probabilities (
)
{
...
void MainWindow::on_open_file_selected (
...
void MainWindow::on_save_file_selected (
    const std::string& file_name
)
{
...
void MainWindow::on_menu_help_help (
)
{
    message_box("Help",
...
void MainWindow::on_graph_modified (
)
{
...
void MainWindow::on_sel_node_evidence_modified (
)
{
...
// a node.
void MainWindow::on_sel_node_num_values_modified (
)
{
    // make a reference to the node in the graph that is currently selected
    node_type& node = graph_drawer.graph_node(selected_node_index);
...
void MainWindow::on_cpt_grid_modified(unsigned long row, unsigned long col)
{
    node_type& node = graph_drawer.graph_node(selected_node_index);
    solution.reset();
...
void MainWindow::on_node_selected (unsigned long n)
{
...
void MainWindow::on_evidence_toggled (
)
{
...
void MainWindow::on_node_deselected ( unsigned long  )
{
    no_node_selected();
}
...
void MainWindow::on_node_deleted (  )
{
    no_node_selected();
}
...
void MainWindow::on_sel_node_text_modified (
)
{
